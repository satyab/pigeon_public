...
function formatAd(params) {
  return '<h3 style="margin:0; padding:0"><a style="text-decoration:none;" href="http://'+params.destUrl+'">'+params.headline+'</a></h3>'+'<div style="color:green;">'+params.destUrl+'</div><div>'+params.text+'</div>';
}
